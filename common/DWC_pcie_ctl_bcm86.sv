...
//
// Filename    : DWC_pcie_ctl_bcm86.v
// Revision    : $Id: //dwh/pcie_iip/main/fairbanks/design/common/DWC_pcie_ctl_bcm86.sv#1 $
// Author      : Rick Kelly/WCYU/LMS 12/03/14
// Description : DWC_pcie_ctl_bcm86.v Verilog module for DWC_pcie_ctl
//
// DesignWare IP ID: 3a71d80a
//
////////////////////////////////////////////////////////////////////////////////

module DWC_pcie_ctl_bcm86 (
    clk,
    rst_n,
    init_n,
    push_req_n,
...
`ifndef SYNTHESIS
  ...
  DWC_pcie_ctl_sva12_b P_RESET_PUSH(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(push_req_n)
  ...
  DWC_pcie_ctl_sva12_b P_RESET_POP(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(pop_req_n)
