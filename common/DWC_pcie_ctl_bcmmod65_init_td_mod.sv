...
// Revision    : $Id: //dwh/pcie_iip/main/fairbanks/design/common/DWC_pcie_ctl_bcmmod65_init_td_mod.sv#1 $
// Author      : ALS/RJK/LMS 12/03/14
// Description : DWC_pcie_ctl_bcm65_td.v Verilog module for DWC_pcie
//
// DesignWare IP ID: edf6c570
//
////////////////////////////////////////////////////////////////////////////////

// This is a modified version of DWC_pcie_ctl_bcm65_td instantiating DWC_pcie_ctl_bcmmod57 instead of DWC_pcie_ctl_bcm57

`undef DWC_NO_CDC_INIT_MODIFIED

module DWC_pcie_ctl_bcmmod65_init_td_mod( 
    clk,
    rst_n,
    init_n,
    push_req_n,
