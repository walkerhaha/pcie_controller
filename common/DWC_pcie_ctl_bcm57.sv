...
// Revision    : $Id: //dwh/pcie_iip/main/fairbanks/design/common/DWC_pcie_ctl_bcm57.sv#1 $
// Author      : Rick Kelly    April 26, 2004
// Description : DWC_pcie_ctl_bcm57.v Verilog module for DWC_pcie_ctl
//
// DesignWare IP ID: 17ca3d14
//
////////////////////////////////////////////////////////////////////////////////



  module DWC_pcie_ctl_bcm57 (
        clk,
        rst_n,
        wr_n,
        data_in,
...
// If read address is out of range of RAM DEPTH, then produce all zeros for read data
    assign read_data = (read_addr <= MAX_ADDR) ? mem[read_addr] : {DATA_WIDTH{1'b0}};
